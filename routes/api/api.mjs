...
import { post_login_user, get_logout_user, post_refresh_token } from '../../controllers/authController.mjs';
...
router.post('/auth/renew_token', post_refresh_token);

// User Routes

router.get('/user/userinfo', passport.authenticate('jwt', { session: false }), get_get_user);
