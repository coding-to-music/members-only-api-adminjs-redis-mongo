...
import { authorize, get_logout_user, post_login_user, post_refresh_token,  } from '../../controllers/authController.mjs';
...
router.get('/user/userinfo', passport.authenticate('jwt', { session: false }), authorize, get_get_user);
